class GovernorateList {
  ...
  GovernorateList({required this.id, required this.governorateNameEn});
  factory GovernorateList.fromJson(Map<String, dynamic> json) {
...
List<GovernorateList> governorates = governorate
    .map((e) => GovernorateList.fromJson(e))
    .toList();
